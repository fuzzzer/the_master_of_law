...
FastAPI Backend (~10K lines, 90 files)
  ...
  │ 22 services, 8 repositories, 9 models, 9 schemas
  ...
  │ 657 tests across 43 test files — all pass (see below)
  ▼
...
| Backend (50 operations, 22 services) | ✅ Done | `backend/` |
...
|---|---|
| With corpus + test DB | 657 passed, 0 skipped |
| Without the corpus (CI) | 645 passed, 12 skipped |
...
and it runs again. Frontend: `fvm flutter test` = 129
