...
/// Creates a conversation linked to this case and handles message exchange.
...
class _CaseChatSectionState extends State<CaseChatSection> {
  ...
  void initState() {
    ...
    )..startConversation(caseId: widget.caseId);
  }
          ...
          Expanded(
            child: BlocBuilder<ConsultationCubit, ConsultationState>(
              builder: (context, state) {
                if (state.status.isLoading && state.messages.isEmpty) {
                  return Center(
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: () => _cubit.startConversation(caseId: widget.caseId),
...
class _MessageBubble extends StatelessWidget {
  ...
  String _trustLabel(String level) {
    return switch (level) {
...
/// Maps [ConsultationFailureType] to user-facing Georgian text.
/// Kept in view layer — cubit only emits typed data, never strings.
