...
**Your Process:**
1.  **Update State:** Modify `.agents/project_guide/architecture_state.md`. Check off the completed features. Add new routes to the GoRouter map, new models to the data dictionary, and new endpoints to the API map.
