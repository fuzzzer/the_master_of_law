...
LEGAL_DOMAINS_LIST: tuple[LegalDomain, ...] = (
    LegalDomain("criminal", "სისხლის სამართალი", "Criminal law",
                ("დანაშაულ", "ბრალ", "დაკავებ", "პატიმრობ", "ცემა", "ქურდობ", "მკვლელობ",
                 "ძალადობ", "პოლიცი", "ნარკოტიკ", "მარიხუან", "კანაფ", "სასჯელ", "მომპარ", "მოპარ")),
    LegalDomain("civil", "სამოქალაქო სამართალი", "Civil law",
                ("ხელშეკრულებ", "ზიან", "ვალი", "საკუთრებ", "დავა", "სესხ", "ქირავ")),
    ...
    LegalDomain("labor", "შრომის სამართალი", "Labor law",
                # Stemmed to nominative-agnostic roots so inflected forms match:
                # "შრომ" hits "შრომის/შრომითი", "სამსახურ" hits "სამსახურში/-იდან",
                # "ხელფას" hits "ხელფასის", "დამსაქმებ" hits "დამსაქმებელმა/-ს".
                ("სამსახურ", "დათხოვნა", "ხელფას", "შრომ", "დამსაქმებ", "თანამშრომ",
                 "მუშაობ", "სამუშაო", "ზეგანაკვეთ", "შვებულებ", "გამათავისუფლ", "გათავისუფლ")),
