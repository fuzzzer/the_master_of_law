...
CASE_INTAKE_SYSTEM = PromptTemplate(
    ...
    template=(
        ...
        "If you do not have any more questions to ask (i.e. you did not output an 'ASK' section), "
        "OR if all critical checklist items are covered, OR the user explicitly asks to proceed:\n"
        "You MUST include the exact tag [CASE_READY] at the very end of your response.\n"
