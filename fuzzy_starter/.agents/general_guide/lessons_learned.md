...
**Problem:** Importing `package:fuzzystarter/src/payments/models/payment_method_data.dart` creates tight coupling.
**Resolution:** Always import through root barrel: `import 'package:fuzzystarter/src/src.dart';`
**Rule:** One import. `import 'package:fuzzystarter/src/src.dart';` is the only project import you write.
